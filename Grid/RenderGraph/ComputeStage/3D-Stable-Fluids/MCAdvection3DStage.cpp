    ...
    : Compute3DStage{ "3D-MCAdvection", "", 8, 8, 8 }
{
    ...
    pDevice->CreateShaderResourceView(_resource[4].Get(), nullptr, _srv[6].ReleaseAndGetAddressOf());
    ...
    pDevice->CreateShaderResourceView(_resource[5].Get(), nullptr, _srv[7].ReleaseAndGetAddressOf());
