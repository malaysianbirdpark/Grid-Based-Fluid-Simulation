...
Compute2DStage::Compute2DStage(char const* name, char const* compute_shader_path, UINT group_x, UINT group_y, UINT group_z)
...
void Compute2DStage::Run(ID3D11DeviceContext& context) {
...
void Compute2DStage::RenderNode() const {
...
void Compute2DStage::SetBarrier(ID3D11DeviceContext& context) const {
